<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'adding_products/product/do_add/', array(
                    ...
                    <div class="tab-content">
                    	<div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="product_name" id="demo-hor-1" placeholder="<?php echo translate('product_title');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-13"><?php echo translate('product_description'); ?></label>
                                <div class="col-sm-6">
                                    <textarea rows="9"  class="summernotes" data-height="200" data-name="product_description"></textarea>
                                </div>
                            </div>
                             <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('product_price');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="product_price" id="demo-hor-1" placeholder="<?php echo translate('product_price');?>" class="form-control required">
                                </div>
                            </div>
                        </div>
